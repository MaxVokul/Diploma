...
// Выводим основной контент главной страницы
?>
    ...
    <section class="tssection">
        ...
        <div class="tssqr" id="tssqr">
            <img class="imgts" src="resources/image%203.png" alt="">
            <div class="tstext">
    ...
    <div class="foryouall">
        <section class="foryouin">
            <div class="row">
                <div class="rect">
                    <img src="resources/Rectangle%2020.png" class="rectimg" alt="">
                    <div class="recttxt">
                ...
                <div class="rect">
                    <img src="resources/Rectangle%2024.png" class="rectimg" alt="">
                    <div>
                        <div class="recttxt">
                            <h2>Sed fringilla mauris sit amet nibh.</h2>
                            <p>
                ...
                <div class="rect">
                    <img src="resources/Rectangle%2025.png" class="rectimg" alt="">
                    <div>
                        <div class="recttxt">
                            <h2>Sed fringilla mauris sit amet nibh.</h2>
                            <p>
            ...
            <div class="row">
                <div class="rect">
                    <img src="resources/image%204.png" class="rectimg" alt="">
                    <div>
                        <div class="recttxt">
                            <h2>Sed fringilla mauris sit amet nibh.</h2>
                            <p>
                ...
                <div class="rect">
                    <img src="resources/Rectangle%2027.png" class="rectimg" alt="">
                    <div>
                        <div class="recttxt">
                            <h2>Sed fringilla mauris sit amet nibh.</h2>
                            <p>
                ...
                <div class="rect">
                    <img src="resources/Rectangle%2026.png" class="rectimg" alt="">
                    <div class="recttxt">
                        <h2>Sed fringilla mauris sit amet nibh.</h2>
                        <p>
                            Curae; In ac dui quis mi consectetuer lacinia. Nam pretium turpis et arcu. Duis arcu tortor, suscipit eget, imperdiet nec, imperdiet iaculis, ipsum.
